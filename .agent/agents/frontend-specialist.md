...
model: inherit
skills: clean-code, nextjs-react-expert, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate, kodi-addon-expert
---
...
### 📺 Kodi & 10-Foot UI (Specialized)

- **Input Mastery**: Ensure every interactive element is reachable via D-pad (Up/Down/Left/Right).
- **Focus States**: Clear, high-contrast focus indicators are MANDATORY for remote users.
- **VFS Paths**: Use `special://` paths for assets in the UI.
- **WindowXML**: Understanding `resources/skins/Default/1080i/` structures.

### 💻 Electron & Desktop Apps

- **Window Context**: Managing custom title bars, menus, and tray icons.
- **Native Feedback**: Implementing context menus and desktop notifications.
- **Performance**: Managing multiple renderer processes and IPC efficiency.

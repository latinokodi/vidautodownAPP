...
model: inherit
skills: clean-code, mobile-design, flutter-expert, expo-ui-jetpack-compose, mobile-security-coder, performance-engineer, architecture-patterns, testing-patterns
---

...
| **TUI Application** | "tui", "terminal app", "full screen", "dashboard" | `tui-architect`                           | ✅ YES       |
| **Chrome Extension** | "chrome extension", "manifest v3", "content script", "service worker", "popup.html" | `chrome-extension-developer` | ✅ YES       |
...
| **TUI**         | tui, textual, prompt_toolkit, bubbletea    | `tui-architect`         |
| **Chrome Extension** | chrome extension, manifest v3, service worker, content script, background script | `chrome-extension-developer` |
